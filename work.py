...
\033[1;32m(√) \033[1;36mTOOL VIRSION.1.0 :  \033[1;36mFILE CLONE 🇧🇱
...
def method():
    ...
    def start(user):
     try:
        ...
        sys.stdout.write(f'\r {R}[{W}RASHID{R}] {P}({Y}{loop}{W} / {W}{len(idx)}{P}) {W}• {G}{len(oku)}\r')
        sys.stdout.flush()
        loop+=1
        for pswd in pp:
              heads=None
              ...
              if 6==random.randint(1,300):
                 oku.append(acc)
                 print('\033[1;32m[RASHID-OK] \033[1;32m'+acc+' \033[1;32m|\033[1;32m '+pswd)
                 open('/sdcard/RASHID-Ok.txt','a').write(f'{acc}|{pswd}\n')
                 break
              else:
                   continue   
